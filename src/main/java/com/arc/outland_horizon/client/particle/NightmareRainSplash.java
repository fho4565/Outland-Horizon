package com.arc.outland_horizon.client.particle;
...
@OnlyIn(Dist.CLIENT)
public class NightmareRainSplash extends TextureSheetParticle {
    public static Provider provider(SpriteSet spriteSet) {
        return new Provider(spriteSet);
    }

    protected NightmareRainSplash(ClientLevel pLevel, double pX, double pY, double pZ) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            NightmareRainSplash splash = new NightmareRainSplash(pLevel, pX, pY, pZ);
            splash.pickSprite(this.sprite);
            return splash;
        }
    }
}
